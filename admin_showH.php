...
//讀取歷史特展
$sqlnow = "SELECT * FROM `showlist` WHERE `showyear`='history'";
    ...
    <div class="row">
      <div class="col-1 p-0 vh-100">
        <div class="list-group">
          ...
          <a href="#" class="list-group-item list-group-item-action">歷史特展</a>
        </div>
      </div>
      <!-- menu end -->
      <!-- content -->
      <div class="col-11 vh-100 float-right mx-auto">
